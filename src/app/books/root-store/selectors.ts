...
import * as fromBooks from './books-store/selectors'
import * as fromSearch from './search-store/selectors'
import * as fromCollection from './collection-store/selectors'
import * as fromBookListState from './books-store/state'
...
} = fromBookListState.adapter.getSelectors(getBookEntitiesState);
...
export const getSearchResults = createSelector(
  ...
  getSearchBookIds,
  (books, searchIds) => {
    return searchIds.map((id:string) => books[id]);
  }
);
